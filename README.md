...
Il sistema adotta un approccio Edge/Fog computing è eseguita quanto più possibile vicino alla sorgente dei dati.  Anche la componente di intelligenza è eseguita sul campo, lasciando al livello cloud solo le attività di addestramento del modello di classificazione sono eseguite sul cloud per sfruttare le risorse computazionali disponibili.
