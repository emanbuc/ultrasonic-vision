...
- [Fog computing - Wikipedia](https://it.wikipedia.org/wiki/Fog_computing)
- [OpenFog_Reference_Architecture_2_09_17.pdf (iiconsortium.org)](https://iiconsortium.org/pdf/OpenFog_Reference_Architecture_2_09_17.pdf)
- [New Reference Architecture Is a Leap Forward for Fog Computing - Cisco Blogs](https://blogs.cisco.com/innovation/new-reference-architecture-is-a-leap-forward-for-fog-computing)
- [Difference Between Fog Computing and Edge Computing | Difference Between](http://www.differencebetween.net/technology/difference-between-fog-computing-and-edge-computing/#:~:text= Difference between Fog Computing and Edge Computing,and reduce the amount of data... More )
- [CosՏ il Fog computing e quale ruolo ha nell'Internet of Things | Internet 4 Things](https://www.internet4things.it/iot-library/cose-il-fog-computing-e-quale-ruolo-ha-nellinternet-of-things/) 
